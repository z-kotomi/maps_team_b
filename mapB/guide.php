    ...
    <body>
        ...
        <div class="guide">
            ...
            <h1>初めての方へ</h1>
                ...
                <img class="guide_img" src="guide_img1.png"><br>
            
                <h2>地図で聖地をすぐに調べられる！<br>
                    豊富な詳細情報・多様なアニメ作品<br></h2>
                <ul>
                    ...
                    <img class="site_guide_img" src="img1.JPG"><br>
                
            <img class="guide_img" src="guide_img2.png"><br>
    
            <h2>会員登録をすれば、さらに便利な機能が！！<br>
                各地にでかける聖地巡礼には最適！！<br></h2>
        
            <h3>③口コミ投稿機能</h3>
                地図上のスポットから詳細画面にアクセスし、一番下の口コミ投稿ボタンをクリックすると、好きな投稿が出来る！<br>
                あなただけの情報をリアルタイムで共有しよう！<br>
        
            <img class="site_guide_img" src="img2.JPG"><br>
            ...
            <img class="site_guide_img" src="img3.JPG"><br>
            ...
            <img class="site_guide_img" src="img4.JPG"><br>
        
            <h2>会員登録をすれば様々な場所に訪れる聖地巡礼中でも<br>
                多様な媒体からアクセスすることができます！<br></h2>
